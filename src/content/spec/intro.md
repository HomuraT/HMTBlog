...
[**EvoThink: Evolving Thinking in Large Reasoning Models via Self-Pruning and Aha-Moment Preference Optimization**](https://arxiv.org/abs/2607.19962)<br>
...
`Large Reasoning Models` `Preference Optimization`
...
[**Code as Representation: A Compilable Parsing Paradigm for Academic Documents**](https://arxiv.org/abs/2608.17550)<br>
...
`Document Parsing` `Multimodality`
...
[**Multimodal emotion recognition based on hierarchical fusion strategy and contextual information embedding**](https://www.proquest.com/openview/4ca30830e494c88fcd8ec156df97f7a6/1?pq-origsite=gscholar&cbl=2048897)<br>
...
`Medical Question Answering` `Causal Inference`

[**Joint span and token framework for few-shot named entity recognition**](https://www.sciencedirect.com/science/article/pii/S2666651023000116)<br>
